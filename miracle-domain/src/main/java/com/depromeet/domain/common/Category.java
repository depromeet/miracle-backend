...
public enum Category {
    READING(Arrays.asList("인상에 남는 구절은 무엇인가요?", "오늘 읽은 책에 대한 나의 생각을 적어주세요.")),
    EXERCISE(Arrays.asList("오늘 하늘은 어땠나요?", "내 몸에서 가장 마음에 드는 곳은 어디인가요?")),
    MEDITATION(Arrays.asList("오늘은 어떤 생각을 하셨나요?", "어떤 꿈을 자주 꾸나요?")),
